...
function deseret_connect_meta_boxen(){
   ...
   $feature_image = $deseret_connect_opts['feature_image'];
   $enable_logging = $deseret_connect_opts['enable_logging'];
...
?>
   ...
   <p><input type="checkbox" value="true" name="feature_image" <?php if($feature_image == 'true'){echo 'checked="checked"'; }?> />
   <label>Feature the first image (requires post-thumbnails theme support)</label></p>
   <p><input type="checkbox" value="true" name="enable_logging" <?php if($enable_logging == 'true'){echo 'checked="checked"'; }?> />
   <label>Enable logging to Deseret Digital Media for debugging.</label></p>
