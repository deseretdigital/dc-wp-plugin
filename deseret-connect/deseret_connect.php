...
define('DESERET_CONNECT_VERSION', '1.0.8');
/**/
/* Set up the plugin. */
...
function deseret_connect_cron_hook(){
    ...
    $requests = $client->getRequests($url, $apiKey, $pending, $author_name, $post_type, $include_canonical, $stateId, $feature_image, $enable_logging);
}
